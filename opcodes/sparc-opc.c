...
{ "t_get_tid",        F3(2, 0x2d, 1), F3(~2, ~0x2d, ~1)|RS1_G0|SIMM13(~0),   "d", 0, 0, 0, v8 },
{ "t_get_pindex",     F3(2, 0x2e, 0), F3(~2, ~0x2e, ~0)|RS1_G0|ASI_RS2(~0),  "d", 0, 0, 0, v8 },
{ "t_get_pindex",     F3(2, 0x2e, 1), F3(~2, ~0x2e, ~1)|RS1_G0|SIMM13(~0),   "d", 0, 0, 0, v8 },
{ "f_get_blockindex", F3(2, 0x2f, 0), F3(~2, ~0x2f, ~0)|ASI_RS2(~0),         "1,d", 0, 0, 0, v8 },
{ "f_get_blockindex", F3(2, 0x2f, 1), F3(~2, ~0x2f, ~1)|SIMM13(~0),          "1,d", 0, 0, 0, v8 },
{ "f_get_blockindex", F3(2, 0x2f, 0), F3(~2, ~0x2f, ~0)|RS1_G0|ASI_RS2(~0),  "d", 0, 0, 0, v8 },
{ "f_get_blockindex", F3(2, 0x2f, 1), F3(~2, ~0x2f, ~1)|RS1_G0|SIMM13(~0),   "d", 0, 0, 0, v8 },
{ "f_break",          F3(3, 0x0e, 0), F3(~3, ~0x0e, ~0)|RD_G0|ASI_RS2(~0),   "1", 0, 0, 0, v8 },
{ "f_break",          F3(3, 0x0e, 1), F3(~3, ~0x0e, ~1)|RD_G0|SIMM13(~0),    "1", 0, 0, 0, v8 },
{ "f_break",          F3(3, 0x0e, 0), F3(~3, ~0x0e, ~0)|RD_G0|RS1_G0|ASI_RS2(~0), "", 0, 0, 0, v8 },
{ "f_break",          F3(3, 0x0e, 1), F3(~3, ~0x0e, ~1)|RD_G0|RS1_G0|SIMM13(~0),  "", 0, 0, 0, v8 },
...
{ "r_freesrb",        F3(3, 0x38, 1), F3(~3, ~0x38, ~1)|RD_G0|SIMM13(~0),    "1", 0, 0, 0, v8 },
{ "t_allochtg",       F3(3, 0x29, 0), F3(~3, ~0x29, ~0)|ASI(~0),             "1,2,d", 0, 0, 0, v8 },
{ "t_allochtg",       F3(3, 0x29, 1), F3(~3, ~0x29, ~1),                     "1,i,d", 0, 0, 0, v8 },
{ "t_freehtg",        F3(3, 0x39, 0), F3(~3, ~0x39, ~0)|RD_G0|ASI_RS2(~0),   "1", 0, 0, 0, v8 },
{ "t_freehtg",        F3(3, 0x39, 1), F3(~3, ~0x39, ~1)|RD_G0|SIMM13(~0),    "1", 0, 0, 0, v8 },
{ "r_write",          F3(3, 0x2a, 0), F3(~3, ~0x2a, ~0)|ASI(~0),             "1,2,d", 0, 0, 0, v8 },
{ "r_write",          F3(3, 0x2a, 1), F3(~3, ~0x2a, ~1),                     "1,i,d", 0, 0, 0, v8 },
{ "r_write",          F3(3, 0x2a, 0), F3(~3, ~0x2a, ~0)|RD_G0|ASI(~0),       "1,2", 0, 0, 0, v8 },
{ "r_write",          F3(3, 0x2a, 1), F3(~3, ~0x2a, ~1)|RD_G0,               "1,i", 0, 0, 0, v8 },
{ "r_read",           F3(3, 0x3a, 0), F3(~3, ~0x3a, ~0)|ASI_RS2(~0),         "1,d", 0, 0, 0, v8 },
{ "r_read",           F3(3, 0x3a, 1), F3(~3, ~0x3a, ~1)|SIMM13(~0),          "1,d", 0, 0, 0, v8 },
{ "f_get_blocksize",  F3(3, 0x3c, 0), F3(~3, ~0x3c, ~0)|ASI_RS2(~0),         "1,d", 0, 0, 0, v8 },
{ "f_get_blocksize",  F3(3, 0x3c, 1), F3(~3, ~0x3c, ~1)|SIMM13(~0),          "1,d", 0, 0, 0, v8 },
{ "f_get_blocksize",  F3(3, 0x3c, 0), F3(~3, ~0x3c, ~0)|RS1_G0|ASI_RS2(~0),  "d", 0, 0, 0, v8 },
{ "f_get_blocksize",  F3(3, 0x3c, 1), F3(~3, ~0x3c, ~1)|RS1_G0|SIMM13(~0),   "d", 0, 0, 0, v8 },
{ "f_get_gridsize",   F3(3, 0x3b, 0), F3(~3, ~0x3b, ~0)|ASI_RS2(~0),         "1,d", 0, 0, 0, v8 },
{ "f_get_gridsize",   F3(3, 0x3b, 1), F3(~3, ~0x3b, ~1)|SIMM13(~0),          "1,d", 0, 0, 0, v8 },
{ "f_get_gridsize",   F3(3, 0x3b, 0), F3(~3, ~0x3b, ~0)|RS1_G0|ASI_RS2(~0),  "d", 0, 0, 0, v8 },
{ "f_get_gridsize",   F3(3, 0x3b, 1), F3(~3, ~0x3b, ~1)|RS1_G0|SIMM13(~0),   "d", 0, 0, 0, v8 },
{ "f_set_blocksize",  F3(3, 0x2c, 0), F3(~3, ~0x2c, ~0)|RD_G0|ASI(~0),       "1,2", 0, 0, 0, v8 },
{ "f_set_blocksize",  F3(3, 0x2c, 1), F3(~3, ~0x2c, ~1)|RD_G0,               "1,i", 0, 0, 0, v8 },
{ "f_set_gridsize",   F3(3, 0x2b, 0), F3(~3, ~0x2b, ~0)|RD_G0|ASI(~0),       "1,2", 0, 0, 0, v8 },
{ "f_set_gridsize",   F3(3, 0x2b, 1), F3(~3, ~0x2b, ~1)|RD_G0,               "1,i", 0, 0, 0, v8 },
{ "f_mapg",           F3(3, 0x2d, 0), F3(~3, ~0x2d, ~0)|ASI(~0),             "1,2,d", 0, 0, 0, v8 },
{ "f_mapg",           F3(3, 0x2d, 1), F3(~3, ~0x2d, ~1),                     "1,i,d", 0, 0, 0, v8 },
{ "f_mapg",           F3(3, 0x2d, 0), F3(~3, ~0x2d, ~0)|RD_G0|ASI(~0),       "1,2", 0, 0, 0, v8 },
{ "f_mapg",           F3(3, 0x2d, 1), F3(~3, ~0x2d, ~1)|RD_G0,               "1,i", 0, 0, 0, v8 },
{ "f_maphtg",         F3(3, 0x3d, 0), F3(~3, ~0x3d, ~0)|ASI(~0),             "1,2,d", 0, 0, 0, v8 },
{ "f_maphtg",         F3(3, 0x3d, 1), F3(~3, ~0x3d, ~1),                     "1,i,d", 0, 0, 0, v8 },
{ "f_maphtg",         F3(3, 0x3d, 0), F3(~3, ~0x3d, ~0)|RD_G0|ASI(~0),       "1,2", 0, 0, 0, v8 },
{ "f_maphtg",         F3(3, 0x3d, 1), F3(~3, ~0x3d, ~1)|RD_G0,               "1,i", 0, 0, 0, v8 },
{ "f_create",         F3(3, 0x2e, 0), F3(~3, ~0x2e, ~0)|ASI(~0),             "1,2,d", 0, 0, 0, v8 },
{ "f_create",         F3(3, 0x2e, 1), F3(~3, ~0x2e, ~1),                     "1,i,d", 0, 0, 0, v8 },
{ "f_create",         F3(3, 0x2e, 0), F3(~3, ~0x2e, ~0)|RD_G0|ASI(~0),       "1,2", 0, 0, 0, v8 },
{ "f_create",         F3(3, 0x2e, 1), F3(~3, ~0x2e, ~1)|RD_G0,               "1,i", 0, 0, 0, v8 },
{ "f_fence",          F3(3, 0x3e, 0), F3(~3, ~0x3e, ~0)|ASI(~0),             "1,2,d", 0, 0, 0, v8 },
{ "f_fence",          F3(3, 0x3e, 1), F3(~3, ~0x3e, ~1),                     "1,i,d", 0, 0, 0, v8 },
{ "f_fence",          F3(3, 0x3e, 0), F3(~3, ~0x3e, ~0)|RD_G0|ASI(~0),       "1,2", 0, 0, 0, v8 },
{ "f_fence",          F3(3, 0x3e, 1), F3(~3, ~0x3e, ~1)|RD_G0,               "1,i", 0, 0, 0, v8 },
{ "f_fence",          F3(3, 0x3e, 0), F3(~3, ~0x3e, ~0)|RD_G0|RS1_G0|ASI(~0),"2", 0, 0, 0, v8 },
{ "f_fence",          F3(3, 0x3e, 1), F3(~3, ~0x3e, ~1)|RD_G0|RS1_G0,        "i", 0, 0, 0, v8 },
{ "t_wait",           F3(3, 0x2f, 0), F3(~3, ~0x2f, ~0)|RD_G0|ASI_RS2(~0),   "1", 0, 0, 0, v8 },
{ "t_wait",           F3(3, 0x2f, 1), F3(~3, ~0x2f, ~1)|RD_G0|SIMM13(~0),    "1", 0, 0, 0, v8 },
{ "t_wait",           F3(3, 0x2f, 0), F3(~3, ~0x2f, ~0)|RD_G0|RS1_G0|ASI_RS2(~0), "", 0, 0, 0, v8 },
{ "t_wait",           F3(3, 0x2f, 1), F3(~3, ~0x2f, ~1)|RD_G0|RS1_G0|SIMM13(~0),  "", 0, 0, 0, v8 },
{ "t_end",            F3(3, 0x3f, 0), F3(~3, ~0x3f, ~0)|RD_G0|RS1_G0|ASI_RS2(~0), "", 0, 0, 0, v8 },
{ "t_end",            F3(3, 0x3f, 1), F3(~3, ~0x3f, ~1)|RD_G0|RS1_G0|SIMM13(~0),  "", 0, 0, 0, v8 },
...
{ "rd",	F3(2, 0x2a, 0),			F3(~2, ~0x2a, ~0)|RS1_G0,		"w,i,d", 0, 0, 0, v6notv9 }, /* rd %wim,i,r */
